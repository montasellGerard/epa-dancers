  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Filtros */}
        <div className="flex flex-wrap gap-2 mb-8" role="group" aria-label="Filtrar eventos">
          {FILTERS.map((f) => {
            ...
            return (
              <button
                ...
                style={
                  active
                    ? {
                        background: f.value === 'congreso' ? '#E0157A' : f.value === 'taller' ? '#F0B429' : '#1A0A00',
                        color: '#fff',
        ...
        {visible.length === 0 ? (
          <div className="col-span-full flex flex-col items-center gap-3 py-16 text-center">
            ...
            <p className="font-sans text-sm" style={{ color: '#7A5230' }}>
              No hay eventos de este tipo próximamente.{' '}
              <a
                ...
                >
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <div className="flex flex-col items-end gap-1">
                      ...
                      {past && (
                        <span
                          className="text-[7px] font-bold uppercase tracking-wider font-sans px-2 py-0.5 rounded-full"
                          style={{ background: 'rgba(0,0,0,0.08)', color: '#7A5230' }}
                        >
                          Finalizado
                        </span>
                      )}
                  ...
                  {!past && (
                    <a
                      href={evt.link}
                      className="flex items-center gap-1.5 text-xs font-bold font-sans pt-2 transition-opacity hover:opacity-70"
...
function LocationIcon() {
  return (
    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="flex-shrink-0" aria-hidden="true">
