export default function Footer() {
  return (
    <footer style={{ background: '#0E0B06' }}>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 flex flex-col items-center gap-5">
        {/* Logo */}
        <span
        ...
        <p className="font-sans text-xs tracking-wide" style={{ color: 'rgba(255,255,255,0.35)' }}>
        ...
        <p className="font-sans text-[10px] tracking-wide" style={{ color: 'rgba(255,255,255,0.15)' }}>
          © 2025 EPA Dancers · Alicia y Pedro
        </p>
      </div>
    </footer>
  )
