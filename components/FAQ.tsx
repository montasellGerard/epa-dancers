  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Resolvemos tus{' '}
          <span style={{ color: '#E0157A' }}>dudas</span>
        </h2>
        <p className="font-sans text-sm mb-10" style={{ color: '#7A5230' }}>
          Si no encuentras tu respuesta, escríbenos por WhatsApp. Sin compromiso.
        </p>
          ...
          {faqs.map((item) => {
            ...
            return (
              <div
                ...
                style={{
                  background:  '#fff',
                  border:      isOpen ? '1px solid rgba(224,21,122,0.25)' : '1px solid rgba(0,0,0,0.07)',
                  boxShadow:   isOpen ? '0 4px 20px rgba(224,21,122,0.08)' : '0 2px 8px rgba(0,0,0,0.04)',
                }}
              >
                {/* Question / trigger */}
                <dt>
                  ...
                  >
                    <span
                      className="font-bold font-sans text-sm leading-snug transition-colors duration-200"
                    ...
                    <span
                      ...
                      aria-hidden="true"
                      style={{
                        background: isOpen ? 'rgba(224,21,122,0.1)' : 'rgba(0,0,0,0.05)',
        ...
        >
          <p className="font-sans text-sm text-center sm:text-left" style={{ color: '#7A5230' }}>
